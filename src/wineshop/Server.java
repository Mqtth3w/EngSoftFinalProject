...
public class Server
{
	...
	**/
	private void run()
	{
	    ...
	    this.pool.execute(new RoundRobinThread(this.db));
		...
		while (!(this.socket.isClosed()))
		{
			try
			{
				...
				this.pool.execute(new ServerThread(this, s, this.db));
			}
			catch (Exception e)
			{
				break;
